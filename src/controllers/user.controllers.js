...
exports.update = async (request, response) => {
    try{
        ...
        await userService.update(id ,username, icon, email, password, twitter, instagram, discord, twitch, biografia, status,  corP, corS, favoritados, conquistas, imgFundo, imgFundoDois, dataCriacao)
        return response.status(201).json({
